...
class _ProductsScreenState extends State<ProductsScreen> {
  ...
  @override
  void initState() {
    _productsBoxHandler.openBox(listinId: widget.listin.id).then((value) => refresh());
  ...
  refresh() {
    List<Product> listProducts = _productsBoxHandler.findAll();

    _filterProducts(listProducts);
  }

  _removeProduct(Product produto) async {
    await _productsBoxHandler.remove(produto);
  ...
  _toggleProductStatus({required Product produto, required String listinId}) {
    ...
    _productsBoxHandler.update(produto);
