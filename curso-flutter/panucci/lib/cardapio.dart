class Cardapio {
  Cardapio._(); // Bloquiei o instanciamento da classe

  static const String _imageInitialPath = "assets/images";

  static const List<Map<String, dynamic>> destaques = [
    {
  ...
  static const List<Map<String, dynamic>> comidas = [
    {
  ...
  static const List<Map<String, dynamic>> pedido = [
    {
      "image": "$_imageInitialPath/chicken-salad.png",
      "name": "Chicken Salad",
      "price": "58.90",
