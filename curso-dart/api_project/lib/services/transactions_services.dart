...
import 'package:api_project/helpers/taxes_helper.dart';
...
class TransactionsServices {
  ...
  final String _url =
      'https://api.github.com/gists/b75c645c32eabf96c046f6a3bd0d40b2';
  ...
  Future<void> makeTransaction({
    ...
    if (senderAccount.balance < (amount + taxes)) {
      throw InsufficientAmountException(
          cause: senderAccount, amount: amount, taxes: taxes);
    }
